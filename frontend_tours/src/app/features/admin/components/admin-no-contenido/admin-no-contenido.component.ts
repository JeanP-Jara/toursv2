...
import { AdminNoContenidoEditarComponent } from '../admin-no-contenido-editar/admin-no-contenido-editar.component';

@Component({
  selector: 'app-admin-no-contenido',
  templateUrl: './admin-no-contenido.component.html',
  styleUrls: ['./admin-no-contenido.component.css']
})
export class AdminNoContenidoComponent extends HeaderComponent implements OnInit {
