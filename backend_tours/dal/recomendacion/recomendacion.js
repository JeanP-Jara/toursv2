...
const getAll = (request, response) => {
    ...
    let cadena = `SELECT a.*, t.nombre as tour FROM recomendacion a 
...
const actualizar = (request, response) => {
    ...
    n_id_recomendacion = request.body.n_id_recomendacion;
    n_id_tours = request.body.n_id_tours;
    c_detalle = request.body.c_detalle;

    let cadena = `UPDATE recomendacion SET n_id_tours = ${n_id_tours}, c_detalle = '${c_detalle}' WHERE n_id_recomendacion = ${n_id_recomendacion}`;
...
const agregar = (request, response) => {
    ...
    let cadena = `INSERT INTO recomendacion(n_id_tours, c_detalle)
...
const eliminar = (request, response) => {
    ...
    let cadena = `DELETE FROM recomendacion WHERE n_id_recomendacion = ${n_id_recomendacion}`;
