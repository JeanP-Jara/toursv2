...
const getAll = (request, response) => {
    ...
    let cadena = `SELECT a.*, t.nombre as tour FROM no_contenido a 
...
const actualizar = (request, response) => {
    ...
    n_idno_contenido = request.body.n_idno_contenido;
    n_id_tours = request.body.n_id_tours;
    c_detalle = request.body.c_detalle;

    let cadena = `UPDATE no_contenido SET n_id_tours = ${n_id_tours}, c_detalle = '${c_detalle}' WHERE n_idno_contenido = ${n_idno_contenido}`;
...
const agregar = (request, response) => {
    ...
    let cadena = `INSERT INTO no_contenido(n_id_tours, c_detalle)
...
const eliminar = (request, response) => {
    ...
    let cadena = `DELETE FROM no_contenido WHERE n_idno_contenido = ${n_idno_contenido}`;
